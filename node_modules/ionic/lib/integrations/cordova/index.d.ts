...
import { InfoItem, IntegrationAddDetails, IntegrationName, ProjectIntegration, ProjectPersonalizationDetails, ProjectType } from '../../../definitions';
export declare class Integration extends BaseIntegration<ProjectIntegration> {
    readonly SUPPORTED_PROJECT_TYPES: readonly ProjectType[];
