...
var ProfissionalConteudoPageModule = /** @class */ (function () {
    function ProfissionalConteudoPageModule() {
    }
    ...
    return ProfissionalConteudoPageModule;
}());
...
var ProfissionalConteudoPage = /** @class */ (function () {
    function ProfissionalConteudoPage(conteudoTextoService, router, auth, navctrl) {
    ...
    ProfissionalConteudoPage.prototype.ngOnInit = function () {
        var _this = this;
        this.idUsuario = this.auth.auth.currentUser.uid;
        this.conteudoTextoService.getTodo(this.idUsuario).subscribe(function (res) {
            _this.todasTexto = res;
        });
    ...
    ProfissionalConteudoPage.prototype.profissionalConteudoTexto = function () { };
    ProfissionalConteudoPage.prototype.profissionalConteudoImagem = function () { };
    ProfissionalConteudoPage.prototype.profissionalConteudoVideo = function () { };
    ProfissionalConteudoPage.ctorParameters = function () { return [
    ...
    return ProfissionalConteudoPage;
}());
...
//# sourceMappingURL=profissional-conteudo-profissional-conteudo-module-es5.js.map