    ...
    componentDidLoad() {
        helpers.rIC(() => {
            ...
            if (!config.config.getBoolean('_testing')) {
                new Promise(function (resolve) { resolve(require('./tap-click-ede5267f.js')); }).then(module => module.startTapClick(config.config));
            }
            if (config.config.getBoolean('statusTap', isHybrid)) {
                new Promise(function (resolve) { resolve(require('./status-tap-ffbf1cc3.js')); }).then(module => module.startStatusTap());
            }
            if (config.config.getBoolean('inputShims', needInputShims())) {
                new Promise(function (resolve) { resolve(require('./input-shims-e03547b7.js')); }).then(module => module.startInputShims(config.config));
            }
            if (config.config.getBoolean('hardwareBackButton', isHybrid)) {
                new Promise(function (resolve) { resolve(require('./hardware-back-button-e8ca0e07.js')); }).then(module => module.startHardwareBackButton());
            }
            new Promise(function (resolve) { resolve(require('./focus-visible-f0deb14c.js')); }).then(module => module.startFocusVisible());
        });
    }
    render() {
...
const Buttons = class {
    ...
    render() {
        return (core.h(core.Host, { class: core.getIonMode(this) }));
    }
...
const Content = class {
    ...
    componentWillLoad() {
        if (this.forceOverscroll === undefined) {
            const mode = core.getIonMode(this);
            this.forceOverscroll = mode === 'ios' && config.isPlatform(window, 'mobile');
        }
    }
    componentDidLoad() {
        this.resize();
    ...
    render() {
        ...
        this.resize();
        return (core.h(core.Host, { class: Object.assign({}, theme.createColorClasses(this.color), { [mode]: true, 'content-sizing': theme.hostContext('ion-popover', this.el), 'overscroll': !!this.forceOverscroll }), style: {
...
const RouterOutlet = class {
    ...
    async componentDidLoad() {
        this.gesture = (await new Promise(function (resolve) { resolve(require('./swipe-back-896f5186.js')); })).createSwipeBackGesture(this.el, () => !!this.swipeHandler && this.swipeHandler.canStart() && this.animationEnabled, () => this.swipeHandler && this.swipeHandler.onStart(), step => this.ani && this.ani.progressStep(step), (shouldComplete, step, dur) => {
            if (this.ani) {
...
const ToolbarTitle = class {
    ...
    render() {
        ...
        return (core.h(core.Host, { class: Object.assign({ [mode]: true, [`title-${mode}`]: true }, theme.createColorClasses(this.color)) }, core.h("div", { class: "toolbar-title" }, core.h("slot", null))));
    }
    get el() { return core.getElement(this); }
