...
var map = {
	"../emergencia-cadastro/emergencia-cadastro.module": [
		...
		"default~emergencia-cadastro-emergencia-cadastro-module~home-home-module~pages-login-login-module~pag~149a80e6",
		"common",
		"emergencia-cadastro-emergencia-cadastro-module"
	],
	...
	"../profissional-perfil/profissional-perfil.module": [
	...
	"../usuario-perfil/usuario-perfil.module": [
...
var routes = [
    ...
    },
    {
        ...
        loadChildren: './pages/profissional-cadastro/profissional-cadastro.module#ProfissionalCadastroPageModule'
    },
    {
        path: 'menu',
...
var AppModule = /** @class */ (function () {
    ...
    AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
            ...
            imports: [_core_core_module__WEBPACK_IMPORTED_MODULE_4__["CoreModule"], _app_routing_module__WEBPACK_IMPORTED_MODULE_3__["AppRoutingModule"]],
...
var CoreModule = /** @class */ (function () {
    function CoreModule(alertController, toastController) {
    ...
    CoreModule.prototype.presentAlert = function (header, msg) {
    ...
    CoreModule.prototype.identificaError = function (error) {
        switch (error) {
...
var AuthService = /** @class */ (function () {
    ...
    AuthService.prototype.createUser = function (email, senha) {
    ...
    AuthService.prototype.signIn = function (user) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            ...
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.AngularFireAuth.auth.signInWithEmailAndPassword(user.email, user.password)];
                    case 1:
                        dados = _a.sent();
    ...
    AuthService.prototype.signOut = function () {
        var teste = this.AngularFireAuth.auth.signOut();
        return teste;
    };
...
var environment = {
    production: false,
    firebase: {
        apiKey: 'AIzaSyCyz_N32Xor6aRRufq1xupN83wfhWrzHTo',
        authDomain: 'tcc-avp.firebaseapp.com',
        databaseURL: 'https://tcc-avp.firebaseio.com',
        projectId: 'tcc-avp',
        storageBucket: '',
        messagingSenderId: '729356460218'
    }
};
