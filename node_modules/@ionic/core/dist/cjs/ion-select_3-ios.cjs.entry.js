...
const SelectOption = class {
    constructor(hostRef) {
         ...
         */
        this.selected = false;
        this.ionSelectOptionDidLoad = core.createEvent(this, "ionSelectOptionDidLoad", 7);
        this.ionSelectOptionDidUnload = core.createEvent(this, "ionSelectOptionDidUnload", 7);
    }
    componentWillLoad() {
        if (this.value === undefined) {
