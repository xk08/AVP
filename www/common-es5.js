...
var StorageService = /** @class */ (function () {
    ...
    StorageService.prototype.uploadImagemAssistenteCadastro = function (idAssistenteCadastro, blob) {
        var ref = this.afs.ref('AssistenteCadastro/' + idAssistenteCadastro + '.jpg');
        var task = ref.put(blob);
        return ref.getDownloadURL();
    };
    StorageService.prototype.uploadImagemEmergenciaCadastro = function (idEmergenciaCadastro, blob) {
        var ref = this.afs.ref('EmergenciaCadastro/' + idEmergenciaCadastro + '.jpg');
        var task = ref.put(blob);
        return ref.getDownloadURL();
    };
