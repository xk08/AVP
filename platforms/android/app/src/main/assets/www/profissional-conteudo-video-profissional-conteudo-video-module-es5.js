...
var ProfissionalConteudoVideoPage = /** @class */ (function () {
    function ProfissionalConteudoVideoPage(route, loadingController, conteudoVideoService, navCtrl, overlay, auth) {
        this.route = route;
    ...
    ProfissionalConteudoVideoPage.prototype.logRatingChange = function (rating) {
