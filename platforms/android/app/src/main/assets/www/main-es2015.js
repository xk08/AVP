...
var map = {
	...
	"../home/home.module": [
		...
		"default~home-home-module~pages-login-login-module~pages-menu-menu-module~pages-profissional-cadastro~3e3b3d64",
		"common",
		"home-home-module"
	],
...
let AuthService = class AuthService {
    ...
    signIn(user) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            const dados = yield this.AngularFireAuth.auth.signInWithEmailAndPassword(user.email, user.password);
            return dados;
        });
    }
    signOut() {
