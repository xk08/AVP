    ...
    componentDidLoad() {
        rIC(() => {
            ...
            if (config.getBoolean('statusTap', isHybrid)) {
                import('./status-tap-2758dfd1.js').then(module => module.startStatusTap());
            }
...
const RouterOutlet = class {
    ...
    async componentDidLoad() {
        this.gesture = (await import('./swipe-back-78383f2a.js')).createSwipeBackGesture(this.el, () => !!this.swipeHandler && this.swipeHandler.canStart() && this.animationEnabled, () => this.swipeHandler && this.swipeHandler.onStart(), step => this.ani && this.ani.progressStep(step), (shouldComplete, step, dur) => {
            if (this.ani) {
