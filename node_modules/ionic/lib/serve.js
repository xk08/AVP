...
class ServeRunner {
    ...
    createOptionsFromCommandLine(inputs, options) {
        ...
        if (options['devapp'] && options['address'] === exports.DEFAULT_ADDRESS) {
    ...
    async selectExternalIP(options) {
        ...
        if (options.address === exports.BIND_ALL_ADDRESS) {
            ...
            this.e.log.warn('An external host may be required to serve for this target device/platform.\n' +
                ...
                `You can use ${color_1.input('--address=0.0.0.0')} to run the dev server on all network interfaces, in which case an external address will be selected.\n`);
        }
