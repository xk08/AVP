...
var TextoDetalhesPageModule = /** @class */ (function () {
    function TextoDetalhesPageModule() {
    }
    ...
    return TextoDetalhesPageModule;
}());
...
var TextoDetalhesPage = /** @class */ (function () {
    function TextoDetalhesPage(route, profissionalTextoService) {
        this.route = route;
        this.profissionalTextoService = profissionalTextoService;
    }
    TextoDetalhesPage.prototype.ngOnInit = function () {
        var _this = this;
        this.idTexto = this.route.snapshot.params['id'];
        this.list = this.profissionalTextoService.getTodo(this.idTexto).subscribe(function (res) {
            _this.maisInfoTela = res.maisInfoTexto;
            _this.tituloTela = res.tituloTexto;
            _this.autorTextoTela = res.autorTexto;
            _this.textoTela = res.texto;
        });
    };
    TextoDetalhesPage.prototype.ngOnDestroy = function () {
        this.list.unsubscribe();
    };
    TextoDetalhesPage.ctorParameters = function () { return [
...
//# sourceMappingURL=texto-detalhes-texto-detalhes-module-es5.js.map