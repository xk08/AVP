...
var CadastroAssistentePage = /** @class */ (function () {
    function CadastroAssistentePage(route, loadingController, assistenteCadastroService, navCtrl, camera, overlay, assistenteCadastro) {
        this.route = route;
...
var AssistenteCadastro = /** @class */ (function () {
    function AssistenteCadastro() {
    }
